          ...
          <address className="not-italic flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-3">
              <a
                ...
                className="font-lato text-sm text-sedef-light hover:text-sedef-lightest transition-colors inline-flex items-center gap-2"
              >
            ...
            <div className="flex flex-col gap-2 mt-2">
              <span className="font-lato text-xs text-sedef-muted inline-flex items-center gap-2">
