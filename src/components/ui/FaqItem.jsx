export default function FaqItem({ item, isOpen, onToggle }) {
  return (
    <div className="border-b border-sedef-mid/30">
      <dt>
        <button
          ...
          className="
            ...
            py-5 text-left
            font-playfair text-lg text-sedef-darkest
            transition-colors duration-200
            hover:text-sedef-mid
            focus-visible:outline-none focus-visible:text-sedef-mid
          "
        >
      ...
      >
        <p className="font-garamond text-base text-sedef-mid leading-relaxed pb-5 pt-1">
          {item.answer}
        </p>
      </dd>
    </div>
